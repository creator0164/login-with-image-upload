...
def get_default_image_filepath(self, filename):
    return f'profile_images/{self.pk}/{"profile_images.png"}'


def get_default_profile_image():
    return "image_cdn/imag1.png"
...
class Account(AbstractBaseUser):
    ...
    profile_image = models.ImageField(max_length=255, upload_to=get_default_image_filepath,
